...
const gameLinks = [
    ...
    {
        nombre: 'tantrix',
        descripcion: 'tantrixDescription',
        ruta: '/games/tantrix',
...
const Header = ({ isDark, toggleTheme }) => {
    ...
    const utilityButtonClass =
        'relative h-10 w-10 flex shrink-0 items-center justify-center rounded-full text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 border border-gray-300 dark:border-gray-600';
    const mobileLinkClass =
        'text-base font-medium text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors px-2 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700';
    ...
    return (
        <header className="sticky top-3 z-30 w-full border-b border-gray-200 bg-white/90 backdrop-blur-md dark:border-gray-700 dark:bg-gray-800/90">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="hidden items-center gap-3 md:flex">
                        ...
                        >
                            ...
                            <div className="relative" ref={gamesMenuRef}>
                                ...
                                >
                                    ...
                                    {t('header.games')}
                                    <ChevronDownIcon
                                        className={`h-3.5 w-3.5 transition-transform ${isGamesOpen ? 'rotate-180' : ''}`}
                                    />
                                </button>

                                {isGamesOpen && (
                                    <div
                                        className="absolute right-0 top-full mt-3 w-72 overflow-hidden rounded-2xl border border-purple-100 bg-white p-2 shadow-xl shadow-purple-950/10 dark:border-gray-700 dark:bg-gray-800"
                                        role="menu"
                                    >
                        ...
                        <button
                            ...
                            aria-label={t('header.themeToggle', {
                                mode: isDark ? t('header.light') : t('header.dark'),
                            })}
                        >
                            {isDark ? (
                ...
                {isMenuOpen && (
                    <nav
                        className="border-t border-gray-200 py-4 dark:border-gray-700 md:hidden"
                        aria-label={t('header.mainNavigation')}
                    >
                        <div className="flex flex-col gap-1">
                            ...
                            >
                                ...
                                <ChevronDownIcon
                                    className={`h-4 w-4 transition-transform ${isMobileGamesOpen ? 'rotate-180' : ''}`}
                                />
                            </button>
                            {isMobileGamesOpen && (
                                    ...
                                    {gameLinks.map(game => {
                                        ...
                                        return (
                                            <Link
                                                ...
                                                to={game.ruta}
                                                onClick={closeMenu}
                                                className="flex items-center gap-3 rounded-xl px-3 py-3 hover:bg-purple-50 dark:hover:bg-gray-700"
                                            >
                            ...
                            {user && (
                                <>
                                    ...
                                    <Link to="/mtg" className={mobileLinkClass} onClick={closeMenu}>
                                        {t('mtg.navLink')}
                                    </Link>
                                </>
                            )}
